...
export default function HeroSection() {
    return (
        <section className="h-screen 2xl:h-[1000px] bg-white py-20 md:py-32 text-center overflow-hidden flex items-center justify-center">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4">
                ...
                <Button className="bg-teal-600 text-white hover:bg-teal-700 px-8 py-3 text-lg rounded-md cursor-pointer">
                    Belajar Sekarang
                </Button>
            </div>
        </section>
